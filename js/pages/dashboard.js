...
import { syncFromKubios, syncTimevarying, getLatestAnalysis } from '../services/analysisService.js';
...
const RECOMMENDATIONS = {
    good: [
        { title: 'Erinomainen palautuminen', desc: 'HRV-arvosi olivat korkealla. Jatka samalla tavalla!', type: 'good' },
        { title: 'Hyvä syvän unen määrä',   desc: 'Syvän unen osuus on ihanteellinen palautumiseen.',  type: 'good' }
    ],
    moderate: [
        { title: 'Optimoi nukkumaanmenoaika', desc: 'Kokeile mennä nukkumaan klo 22–23 välillä.',       type: 'warn' },
        { title: 'Stressinhallinta',          desc: 'HRV-arvosi viittaavat kohonneeseen kuormitukseen.', type: 'warn' }
    ],
    poor: [
        { title: 'Heikko palautuminen', desc: 'Suosi kevyttä päivää ja vältä ylimääräistä kuormitusta.', type: 'warn' },
        { title: 'Lisää unta',          desc: 'Pyri nukkumaan vähintään 7–8 tuntia seuraavana yönä.',    type: 'warn' }
    ]
};
...
function updateScoreCard(data) {
    ...
    document.getElementById('scoreRating').textContent    =
        readiness >= 70 ? 'Erinomainen' :
        readiness >= 40 ? 'Kohtalainen' : 'Heikko';
